...
/**
 * NotificationDropdown — Notification history dropdown accessible from the top bar.
 *
 * Displays the most recent 50 notifications with read/unread status, ordered
 * newest to oldest. Includes:
